...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header" style="align-self: center">FIRMA DE DOCUMENTO
                </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col col-md-4">
                            <a href="{{ route('sign.check.ko' , $doc['id']) }}" type="button" class="btn btn-danger">CANCELAR</a>
                        </div>
                        <div class="col col-md-4">
                            <a href="{{ route('sign.check.ok' , $doc['id']) }}" type="button" class="btn btn-success">ACEPTAR</a>
                        </div>
                    </div>
                </div>
            </div>
...
@section('view','signs/check.blade.php')