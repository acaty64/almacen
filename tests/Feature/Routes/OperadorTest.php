...
class OperadorTest extends TestCase
{
    ...
    /** @test */
    public function operator_user_without_access_input_is_redirect_to_access_route()
    {
    ...
    /** @test */
    public function operador_can_visit_the_operador_dashboard()
    {
        $access = Access::where('tuser_id', 3)->first();
        $user = User::findOrFail($access->user_id);
    ...
    /** @test */
    public function master_can_visit_the_operador_dashboard()
    {
    ...
    /** @test */
    public function admin_can_visit_the_operador_dashboard()
    {
    ...
    /** @test */
    public function decano_users_cannot_visit_the_master_dashboard()
    {
    ...
    /** @test */
    public function guests_cannot_visit_the_operador_dashboard()
    {
